...
- Read some Linux documentation and try to use the standard library using just the documentation
...
- **System clock**: Calling `clock_gettime(CLOCK_MONOTONIC, &ts)` using `time.h`.
...
| 1 | 2.76298e-08 | 1000000 | 0.00060729 | 4.54968e-05 | using clock_gettime instead of std::chrono |
| 1 | 2.41068e-08 | 1000000 | 0.000251451 | 9.58707e-05 | using clock_gettime instead of std::chrono |
...
- Sometimes, I saw the overhead ratio almost half from 9e-05 to about 4.5e-05. Not really sure why this happened and why this number repeatedly, but it didn't seem very reproduceable.
